  ...
  while ((Y+tol >= YF) || (Y-tol <= YF))
  {
    ...
    switch (SwitchTranslation)
    {
      case 1:
        ...
        timer1 = millis();
        rlyflag = true;
        if (rlyflag && (millis()-timer1) > tydiv/2)
        {
...
void xtranslation(int SwitchTranslation, float Xarray[], int txdiv)
{
  ...
  while ((X+tol >= XF) || (X-tol <= XF))
  {
    ...
    switch (SwitchTranslation)
    {
      case 1:
        ...
        timer1 = millis();
        rlyflag = true;
        if (rlyflag && (millis()-timer1) > txdiv/2)
        {
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~Yarray and Xarray Update~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

void fillArray(float *someArray, float value)
{
  int i;
